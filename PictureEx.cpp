...
void CPictureEx::OnPaint() 
{
 ...
 else
 {
  if(AutoStretch)
  {
   ::StretchBlt(dc.m_hDC, 0, 0, m_ObjectArea.cx, m_ObjectArea.cy, 
   m_hMemDC, m_PaintRect.left, m_PaintRect.top,m_PictureSize.cx, m_PictureSize.cy, SRCCOPY);
  }
  else
  {
